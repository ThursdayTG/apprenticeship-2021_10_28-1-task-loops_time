...
int main(){
	...
	/*
	 * Aufgabe:
	 * Die Sekundenangabe soll einheitlich angezeigt werden.
	 * D.h. die Anzeige von Sekunden soll nicht von den Tabulatorsprüngen bei Stunden- und Minutenwechsel beeinflusst werden.
	 *
	 */
	...
	for (	h	=	0;				// Stunden
		...
		for (	m	=	0;			// Minuten
			...
			for (	s	=	0;		// Sekunden
				...
				if (tabM == "")		cout << "\t";
				if (tabS == "")		cout << "\t";
				cout	<< sTotal << "-te Sekunde des Tages"
						<< "\n";
