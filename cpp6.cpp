...
int main(){
	...
	/*
	 * Aufgabe:
	 * Nach jeder Zeitausgabe soll zusätzlich ausgegeben werden, welche Sekunde des Tages die jeweilige Zeit ist.
	 * Beispiel:
	 * 		00.00.01	1. Sekunde
	 * 		00.00.02	2. Sekunde
	 *
